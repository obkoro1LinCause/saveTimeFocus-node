...
export declare class UserController {
    ...
    register(registerDto: RegisterDto): Promise<import("..").User | "该邮箱已被注册，请前往登录页面" | "验证码有效期为三十分钟，请重新发送邮箱验证码" | "邮箱验证码错误，请确认" | "邀请码错误，请确认">;
    login(loginDto: BaseDto, req: any): Promise<{
        token: unknown;
        email: string;
    }>;
